...
instrument = minimalmodbus.Instrument('/dev/serial/by-id/usb-1a86_USB2.0-Serial-if00-port0', 1, mode='rtu') # port name, slave address (in decimal)
...
try:
	...
	print "voltage1=" + str(convert_in_float( read_values1[0], read_values1[1]))
        ...
        # Frequency
        print "frequency=" + str(convert_in_float( read_values1[72], read_values1[73]))
